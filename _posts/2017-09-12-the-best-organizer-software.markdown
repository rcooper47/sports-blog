...
Or Studying an Experiment in Learning?  Regardless, the goal will be to use everything I've learned about efficiently doing well in college to...do well in college.  I've created three phases? stages? parts?  of a 5? step program to get me back on track.  In an effort to gain more data, with the added benefit of helping them earn a 4.0 (we believe), an anonymous person will be completing the program with me.  Their chosen alias is 'Tom Boy'.  
